...
--
-- TODO: Many are broken and need to be rewritten not to rely on C library
-- functions (FHW)
--
-----------------------------------------------------------------------------
...
isControl               :: Char -> Bool
isControl _ = False -- FHW: TODO

-- | Selects printable Unicode characters
-- (letters, numbers, marks, punctuation, symbols and spaces).
isPrint                 :: Char -> Bool
isPrint _ = True -- FHW: TODO
...
isSpace c               =  c == ' '     ||
                           ...
                           c == '\v'    ||
                           c == '\xa0' --  ||
--                           iswspace (fromIntegral (ord c)) /= 0 -- FHW

-- | Selects upper-case or title-case alphabetic Unicode characters (letters).
-- Title case is used by a small number of letter ligatures like the
-- single-character form of /Lj/.
isUpper                 :: Char -> Bool
isUpper _ = False -- FHW: TODO

-- | Selects lower-case alphabetic Unicode characters (letters).
isLower                 :: Char -> Bool
isLower _ = False -- FHW: TODO

-- | Selects alphabetic Unicode characters (lower-case, upper-case and
-- title-case letters, plus letters of caseless scripts and modifiers letters).
-- This function is equivalent to 'Data.Char.isLetter'.
isAlpha                 :: Char -> Bool
isAlpha _ = False -- FHW: TODO
...
toUpper                 :: Char -> Char
toUpper c = c -- FHW: TODO

-- | Convert a letter to the corresponding lower-case letter, if any.
-- Any other character is returned unchanged.
toLower                 :: Char -> Char
toLower c = c -- FHW: TODO
