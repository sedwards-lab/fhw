...
-}
-- FHW: we don't support newtype, so patched with an algebraic type
...
-- FHW: This generates a syntactically incorrect .hcr file
-- 
--  %data ghczmprim:GHCziTypes.z7eU aa1 ba2 =
--    {ghczmprim:GHCziTypes.Eqzh (ghczmprim:GHCziPrim.z7eUzh
--                                ghczmprim:GHCziPrim.zt
--                                aa1
--                                ba2)};
--
-- Because type constructor names are supposed to start with an uppercase
-- letter.  It chokes on the z7eU (~), z7eUzh (~#), and zt (~)
